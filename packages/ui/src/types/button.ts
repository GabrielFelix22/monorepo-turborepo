  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*=size-])]:size-4 shrink-0 outline-none focus-visible:ring-2 focus-visible:ring-ring cursor-pointer',
  {
    variants: {
      variant: {
        ...
        'outline-blue': 'border border-blue-600 text-blue-600 bg-transparent hover:bg-blue-50',
        'outline-green': 'border border-green-600 text-green-600 bg-transparent hover:bg-green-50',
        'outline-red': 'border border-red-600 text-red-600 bg-transparent hover:bg-red-50',
        'outline-purple': 'border border-purple-600 text-purple-600 bg-transparent hover:bg-purple-50',
      },
      size: {
